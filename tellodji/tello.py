...
class Tello:
    ...
    def _send(self, msg: str, typ: str, callback: Callable | bool | None = False, val: int | tuple[Union[int, str]] = None) -> str:
        '''
        Internal method for sending data synchronously to the drone. You normally wouldn't use this yourself
        '''

        if callback != False and callback != None and not callable(callback): raise ValueError('Callback function is incorrect. Please make sure it\'s a callable')
