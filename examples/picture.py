...
# Takes a photo into the directory ./other_photos in 480p. Then displays in the default image viewing program on your platform
drone.photo(path = './other_photos/', resolution = (852, 480), window = True)
